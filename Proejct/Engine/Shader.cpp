...
void Shader::Init(const wstring& path)
{
	/*
		렌더링 파이프 라인에서
		각 단계마다 어떻게 해야할지 기술 할 수 있다.

		가장 중요하게 활용하는것은
		VertexShader 와 PixelShader 다.

	*/
	CreateVertexShader(path, "VS_Main", "vs_5_0"); // 셰이더 파일에 적혀져있는 이름 'VS_MAIN'
	CreatePixelShader(path, "PS_Main", "ps_5_0"); // 셰이더 파일에 적혀져있는 이름 'PS_MAIN'
